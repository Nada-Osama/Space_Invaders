...
unsigned int countKilledEnemies = 0;
unsigned int playerPosX = 33;
unsigned int laserX = 40;
...
int main(void){
  ...
  while(1){
			...
			if(countKilledEnemies == 5)  //checking that all enemies were killed
			{
					Nokia5110_Clear();
					Nokia5110_SetCursor(1, 1);
					Nokia5110_OutString("Congratulations, ");
